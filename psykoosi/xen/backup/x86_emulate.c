...
memcpy((void *)&_temp_regs, (void *)&_regs, sizeof(struct cpu_user_regs)); \
    switch ( (_dst).bytes )                                                \
    {                                                                      \
    case 2:                                                                \
        asm volatile (                                                     \
    ...
    const struct x86_emulate_ops  *ops)
{
    ...
    struct cpu_user_regs _temp_regs;
...
#define REPNE_PREFIX 2
    ...
    printf("shadow regs esp %p\n", &_regs.esp);
    if (_regs.eip == 0x7c912b01) __asm("int3");
