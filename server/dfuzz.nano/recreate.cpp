...
memset(query,0,1024);
    ...
    querylen = snprintf(query, sizeof(query) - 1, "SELECT *,unix_timestamp(ts) from exceptions where exception_code like \"%406D1388%\" group by exception_address,exception_code");
if (id)
